 ...
 *     },
 * }
 * @psalm-type NuxtGeneratorConfig = array{
 *     output_path?: scalar|Param|null, // Path to the Nuxt project root (will generate files in {output_path}/generated/)
 *     defaults?: array{
 *         clean_before_generate?: bool|Param, // Clean generated directory before generating // Default: true
 *         generate_hydra_helpers?: bool|Param, // Generate Hydra pagination helpers // Default: true
 *         strict_null_checks?: bool|Param, // Enable strict null checks in TypeScript // Default: true
 *         default_items_per_page?: int|Param, // Default items per page for pagination // Default: 30
 *     },
 *     client?: array{
 *         base_url?: scalar|Param|null, // Base URL for API calls // Default: "/api"
 *         credentials?: scalar|Param|null, // Credentials mode for fetch (include, same-origin, omit) // Default: "include"
 *     },
 *     naming?: array{
 *         type_suffixes?: array{
 *             collection_output?: scalar|Param|null, // Suffix for collection output types // Default: "List"
 *             item_output?: scalar|Param|null, // Suffix for item output types // Default: "Detail"
 *             create_input?: scalar|Param|null, // Suffix for create input types // Default: "CreateInput"
 *             update_input?: scalar|Param|null, // Suffix for update input types (PATCH) // Default: "UpdateInput"
 *             replace_input?: scalar|Param|null, // Suffix for replace input types (PUT) // Default: "ReplaceInput"
 *             query?: scalar|Param|null, // Suffix for query parameter types // Default: "Query"
 *         },
 *     },
 * }
 ...
 *     nuxt_generator?: NuxtGeneratorConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
